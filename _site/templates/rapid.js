var context = {
  ...
  "mission": {
    ...
    "description":`Bruin Space is embarking on our first real spacecraft with URSa: a 3U CubeSat. Designed to be a high power spacecraft bus, we will be supporting the research efforts of the <a href="wirz.seas.ucla.edu/plasma">Plasma and Space Propulsion Lab at UCLA</a>.`,
    "description_2":`The UCLA Research Satellite (URSa) is a conceptualized 3U CubeSat capable of supporting up to a 60W Electric Propulsion (EP) payload by switching between charging and thrusting modes. <a href="https://www.cubesat.org/">The CubeSat standard</a>, which is built upon 10x10x10cm Units (U), provides a efficient platform for both design and launch. With a 40W solar array and a 50Whr battery it is possible to supply an EP payload with high power for a variable interval of time before needing to recharge. The spacecraft bus is able to provide command and data handling, attitude control, and communications with 2U of space, leaving 1U for the payload.`,
    "model": {
