...
$(document).ready(function(){
  $(window).scroll(function() {
    ...
    console.log(top)
    console.log($("#mission1").position().top)
/*
    if (top > $("#mission3").position().top - buffer){
      //console.log("step 1")
      $("#mission1_image").hide()
      $("#mission2_image").hide()
      $("#mission3_image").show()
    } else if (top > $("#mission2").position().top - buffer){
      //console.log("step 2")
      $("#mission1_image").hide()
      $("#mission3_image").hide()
      $("#mission2_image").show()
    } else if ($(document).scrollTop() > ($("#mission1").position().top - buffer)){
      //console.log("step 3")
      $("#mission1_image").show()
      $("#mission2_image").hide()
      $("#mission3_image").hide()
      ...
      //$(".scrollable-content__images").hide();
    }
    */
