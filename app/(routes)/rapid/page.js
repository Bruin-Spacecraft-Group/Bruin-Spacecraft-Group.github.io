        ...
        <div className='grid grid-cols-9 max-md:grid-cols-1 gap-32 lg:gap-y-40 mb-10 place-items-center'>
          ...
          <div className='col-span-5 max-md:col-span-1'>
            <div className='mb-20'>
              ...
              <br />
              <p>RAPID-0 is a 3U cubesat, currently being developed by the Project Rapid team. It will be Project Rapid’s first satellite launched into space and the predecessor to future satellites capable of carrying high-power, high-volume, pointing-requiring payloads. RAPID-0's design is based on engineering development for RAPID-1, and carries over much of the custom technology developed for its ion thruster.</p>
            </div>
            <div>
              <h3 className='text-3xl'>Satelite Goals</h3>
              <br />
              <p>RAPID-0 seeks to increase the TRL of a high-power, high-volume, pointing-capable testbed. Giving these systems flight heritage will contribute to confidence and reliability for future payloads. Significant expererimental technologies of which RAPID-0 aims to increase the TRL include:</p>
              <br />
              <li>Full ADCS (Attitude Determination & Control Systems) module.</li>
      ...
      <section className="pb-10 md:pb-14 mt-20 mb-10 px-10 lg:px-24">
        <div className='grid grid-cols-2 max-md:grid-cols-1 gap-10 lg:gap-12 mb-10 place-items-center'>
          <div>
            ...
            <br/><br/>
            <p> BruinSpace has developed significantly since the creation of Project Rapid, with the goal of providing high quality enginereing experience for efficient design, prototyping, and manufacturing. <br/><br/> Our lab has worked to create a full soldering station, ESD-protected storage and workbenches, lab computers, 3D-printers, spot-welder, plenty of hardware tool kits, machinery tools, and more in order to achieve our goals punctually. We've also grown organizationally, with developed standards, tools, practices, and resources for our members. </p>
          </div>
          <Timeline />
        </div>
      </section>
      ...
      <section className="pb-10 md:pb-14 mt-20 mb-10 px-10 lg:px-24">
        ...
        <div className='grid grid-cols-2 max-md:grid-cols-1 gap-10 lg:gap-12 mb-10 place-items-center'>
          <div>
            ...
            />
            <br />
            <p className='text-center'> <span className='font-semibold'>Ian Lee</span> <br /> Project Manager</p>
          </div>
          <div>
            <Image
            ...
            />
            <br />
            <p className='text-center'> <span className='font-semibold'>Randall Scharpf</span> <br /> Chief Engineer</p>
          </div>
        </div>
      </section>
    </main >
