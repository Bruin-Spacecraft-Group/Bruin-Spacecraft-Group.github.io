      ...
      <section className="pb-10 md:pb-14 mt-60 mb-10 px-10 lg:px-24">
        <div className="relative flex flex-col justify-end h-full">
          ...
          <p className="text-lg font-extrabold text-light lg:text-l px-wrapper-mobile lg:px-wrapper-desktop hidden-br hidden-br--xl">
            Where Innovation Meets Passion, and Students from All Disciplines
            Unite to Pioneer the Future of Space Exploration.
          </p>
        </div>
      </section>
      <section className="pb-10 md:pb-14 mt-40 mb-10 px-10 lg:px-24">
        ...
        <div className="grid grid-cols-9 max-md:grid-cols-1 gap-6 lg:gap-12 mb-20 place-items-center">
          ...
          <p className="col-span-5">
            BruinSpace at UCLA is a student-led organization dedicated to
            fostering innovation, collaboration, and hands-on experience in the
            field of aerospace engineering. We are more than just a club; we are
            a community where students from all disciplines—engineering,
            science, business, arts, and beyond—come together to explore the
            vast possibilities of space exploration.
            <br />
            <br />
            Our mission is to empower the next generation of space leaders by
            providing opportunities to design, develop, and execute real-world
            space missions. Through our flagship projects, such as CubeSat
            development and high-altitude balloon payloads, BruinSpace members
            gain invaluable experience in the full lifecycle of space technology
            projects—from concept and design to manufacturing, testing, and
            launch.
            <br />
            <br />
            Located within the heart of the aerospace industry in Southern
            California, BruinSpace leverages UCLA’s strong ties with industry
            leaders, offering students unique opportunities to connect with
            professionals, secure mentorship, and collaborate on cutting-edge
            research. Our members are not only building tangible projects; they
            are also shaping the future of space technology.
            <br />
            <br />
            BruinSpace is committed to diversity and inclusivity, welcoming
            students from all backgrounds and academic interests. Whether you're
            an engineer, a scientist, a business major, or an artist, there’s a
            place for you in BruinSpace. Our interdisciplinary approach ensures
            that every member can contribute meaningfully to our projects and
            initiatives, bringing fresh perspectives and innovative ideas to the
            table.
            <br />
            <br />
            Through hands-on projects, educational programs, and industry
            partnerships, BruinSpace is creating an environment where students
            can grow, lead, and make a tangible impact on the world of space
            exploration. We are passionate about what we do, and we invite you
            to join us as we push the boundaries of what’s possible.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-3 max-md:grid-cols-1 gap-10 lg:gap-12 mb-10">
          <div>
            ...
            <p className="text-center">
              {" "}
              <span className="font-semibold">Rit Agarwal</span> <br />{" "}
              President
            </p>
          </div>
          <div>
            ...
            <p className="text-center">
              {" "}
              <span className="font-semibold">June Lee</span> <br /> Internal
              Vice-President
            </p>
          </div>
          <div>
            ...
            <p className="text-center">
              {" "}
              <span className="font-semibold">Adrian Rodriguez-Arana</span>{" "}
              <br /> External Vice-President
            </p>
          </div>
          <div>
            <Image
            ...
            <p className="text-center">
              {" "}
              <span className="font-semibold">Noor Saiedy</span> <br /> Finance
              Vice-President
            </p>
          </div>
          <div>
