      ...
      <section className="pb-10 md:pb-14 mb-10 px-10 lg:px-24">
        <div className="grid grid-cols-6 max-md:grid-cols-1 gap-6 lg:gap-16 mb-10">
          ...
          <div className="col-span-5">
            <p className="font-extralight text-xl lg:text-2xl">
              Bruin Spacecraft Group was founded with the intent of providing a
              creative and supportive environment for space mission design and
              development at UCLA. Here, students of all backgrounds can come
              together, united by a passion for space, to do something amazing.
              Here, we aim to give students the opportunity to acquire the
              skills necessary to become leaders in the space industry.
            </p>
          </div>
        </div>
        <div className="pb-10">
        ...
        <div className="grid w-full h-full place-content-center">
          <Link href="/rapid">
            <Image
              ...
              height={300}
            />
            <p className="text-xl text-[#c64242] text-center">
              CUBESAT DEVELOPMENT
            </p>
          </Link>
        </div>
        ...
        <div className="grid w-full h-full place-content-center">
          <Link href="/">
            <Image
              ...
              height={300}
            />
            <p className="text-xl text-[#50d4ec] text-center">
