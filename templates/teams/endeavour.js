var context = {
    ...
    "project_description": "Many projects under Bruin Spacecraft Group build spacecraft and scientific payloads " +
        "with an understanding of engineering principles. The goal of Endeavour is to apply this engineering ethos " +
        "to more theoretical projects, harnessing Bruin Space’s available talent in physics, data science, and " +
        "more. Our projects are motivated by academic curiosity, but we are constantly looking towrads the needs " +
        "of the rest of the Bruin Space community for our research questions.",
    "team_description":"",
