    ...
    'jobs': [
        {
            ...
            'description': 'Develop the critical electronics for a student-built, plasma-propelled CubeSat! The ' +
                'Digital Control Interface Unit (DCIU) is the "brains" of the propulsion system, translating ' +
                'commands from the craft Command and Data Handling (CDH) system into power supply commands for ' +
                'the ion thruster and managing the operation, startup, and shutdown of the thruster system.',
        ...
        },
        {
            ...
            'description': 'Develop the critical electronics for a student-built, plasma-propelled CubeSat! The ' +
                'Power Processing Unit (PPU) is the set of power supplies that converts the low-voltage (typically ' +
                '5-20 V) power from the craft into the high voltages needed for ion thruster operation (200-1000 V).',
            'link': 'https://forms.gle/uiJ2M4FUsc6AanTz5',
            'linkText': 'Apply Here',
            'required-skills':[
                {'skill': 'Ability to work and pull weight in a team'},
        ...
        },
        {
            ...
            'description': 'Develop flight hardware for a miniature ion propulsion system! The propellant ' +
                'management system precisely controls the flow of gas to the ion thruster in microgravity ' +
                'using a series of pressure regulators, valves, and precisely calibrated orifices.',
            'link': 'https://forms.gle/uiJ2M4FUsc6AanTz5',
            'linkText': 'Apply Here',
            'required-skills':[
                {'skill': 'Ability to work and pull weight in a team'},
        ...
        },
        {
            ...
            'description': 'Python based software development controlling power distribution, data collection, ' +
        ...
        },
        {
            ...
            'description': 'Python and web based operational software development, focused on providing a user ' +
        ...
        },
        {
            ...
            'description': 'Assist in design of spacecraft thermal control system, perform calculations, and ' +
                'run simulations with industry software Thermal Desktop.',
            'link': 'https://forms.gle/uiJ2M4FUsc6AanTz5',
            'linkText': 'Apply Here',
        },
        {
        ...
        },
        {
            ...
            'description': 'Development and verification of requirements, resource allocation and numerical ' +
                'system analysis.',
            //'link': links.reach,
            //'linkText': 'Learn More'
        },
        {
            ...
            'description': 'Support Model Based Systems Engineering efforts working with industry leading ' +
                'modeling software Cameo Enterprise Architect. Design system-describing diagrams in accordance ' +
        ...
        },
        {
            ...
            'description': 'Manage website content, develop new website features, working with the Handlebars ' +
                'templating framework, SASS, and JavaScript.',
            //'link': links.reach,
            //'linkText': 'Learn More'
        },
        {
...
var templateScript = Handlebars.templates['info/openings'](context);
