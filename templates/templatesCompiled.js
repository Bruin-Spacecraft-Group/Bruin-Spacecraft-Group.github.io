...
templates['our_mascot'] = template({"1":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
  ...
  return "					<div class=\"text-image__container light "
    ...
    + "\">\r\n			</div>\r\n			<p class=\"paragraph-container\">\r\n				"
    + alias4(((helper = (helper = helpers.project_description || (depth0 != null ? depth0.project_description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"project_description","hash":{},"data":data}) : helper)))
    + "\r\n		 <div class=\"project-description dark\">\r\n		<h1 class=\"title\"></h1>\r\n	</p>\r\n		</div>\r\n	</div>\r\n	<div class=\"team-description light\">\r\n		<p class=\"title\"> ''The creation of Bru was actually an accident, just like many other wonderful space discoveries! They were supposed to be a funny little background doodle in presentation slide backgrounds, but once the marketing team realized how adorable the character was, I had to evolve this little bear into a full character. The name Bru was chosen because it is a pun for the name of the club (Bru in Space). And now they reside, surrounded by stars and endless possibility, discovering and learning just like the Bruins on Earth.'' -Jeanine Lee, Creator</p>\r\n		<div class=\"team-description__content\">\r\n	"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.mission : depth0)) != null ? stack1.callToAction_raw : stack1),{"name":"if","hash":{},"fn":container.program(19, data, 0),"inverse":container.program(21, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>\r\n";
},"useData":true});
