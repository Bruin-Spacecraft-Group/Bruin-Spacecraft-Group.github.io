...
templates['info/join'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"team-wrapper\" class=\"parallax-wrapper\">\n    <div class=\"project-header\">\n        <div class=\"parallax-image-header parallax-image\"></div>\n        <div class=\"project-header__title\">\n            <h1>Join the Team</h1>\n        </div>\n    </div>\n    <div class=\"project-intro dark\">\n        <h1>Learn how you can get involved</h1>\n        <p>Scientist or artist, policy-maker or engineer, our only requirement is a passion for space.</p>\n    </div>\n    <div class=\"parallax-image-header__follow parallax-image\"></div>\n    <div class=\"text-image__container light text-left\">\n        <h1 class=\"title\">Find your Place</h1>\n        <div class=\"text-image image-left\">\n            <img src=\""
    ...
    + ", "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"reach") || (depth0 != null ? lookupProperty(depth0,"reach") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"reach","hash":{},"data":data,"loc":{"start":{"line":21,"column":105},"end":{"line":21,"column":116}}}) : helper))) != null ? stack1 : "")
    + "\n                        or "
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"endeavour") || (depth0 != null ? lookupProperty(depth0,"endeavour") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"endeavour","hash":{},"data":data,"loc":{"start":{"line":23,"column":60},"end":{"line":23,"column":75}}}) : helper))) != null ? stack1 : "")
    + ".</li>\n                    <li>If you want to develop industry contacts, handle corporate relations, and public outreach\n                        efforts, consider our "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"externalAffairs") || (depth0 != null ? lookupProperty(depth0,"externalAffairs") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"externalAffairs","hash":{},"data":data,"loc":{"start":{"line":25,"column":46},"end":{"line":25,"column":67}}}) : helper))) != null ? stack1 : "")
    + " team.</li>\n                    <li>For experience managing accounts and applying for funds, join the "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"finance") || (depth0 != null ? lookupProperty(depth0,"finance") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"finance","hash":{},"data":data,"loc":{"start":{"line":26,"column":90},"end":{"line":26,"column":103}}}) : helper))) != null ? stack1 : "")
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"marketing") || (depth0 != null ? lookupProperty(depth0,"marketing") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"marketing","hash":{},"data":data,"loc":{"start":{"line":28,"column":65},"end":{"line":28,"column":80}}}) : helper))) != null ? stack1 : "")
    + " team.</li>\n                </ul>\n                <a class=\"openings-link\" href=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"openingsLink") || (depth0 != null ? lookupProperty(depth0,"openingsLink") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"openingsLink","hash":{},"data":data,"loc":{"start":{"line":30,"column":47},"end":{"line":30,"column":63}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"slack") || (depth0 != null ? lookupProperty(depth0,"slack") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"slack","hash":{},"data":data,"loc":{"start":{"line":64,"column":22},"end":{"line":64,"column":31}}}) : helper)))
    + "\">\n            <div class=\"paragraph-container\">\n                <p>\n                    <a href=\"https://slack.com\">Slack</a> is a communication platform built for teams. Channels allow\n                    information to be exchanged with those it impacts the most. You'll automatically be added to\n                    <code>#bruinspace</code>, where all official, group-wide communication happens, and\n                    <code>#deorbit</code>, where we share space news, organize social events and stuff!\n                </p>\n                <p>\n                    Our slack domain, <a href=\"https://bruinspace.slack.com\">bruinspace.slack.com</a>, is accessible\n                    to anyone with a UCLA email. If you don't have a UCLA email, just message us on\n                    <a href=\"https://www.facebook.com/uclaBruinSpace/\">Facebook</a> or shoot us an\n                    <a href=\"mailto:uclaBruinSpace@gmail.com\">email</a> and we'll get you set up!\n                </p>\n            </div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
...
templates['teams/admin'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", alias4=container.escapeExpression, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
templates['teams/project'] = template({"1":function(container,depth0,helpers,partials,data) {
